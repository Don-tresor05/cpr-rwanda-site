    ...
    children: [
      {
        ...
        links: [
          { label: t("nav.whoWeAre"), href: "#who", desc: t("nav.whoWeAreDesc") },
          { label: t("nav.visionMission"), href: "#vision", desc: t("nav.visionMissionDesc") },
          { label: t("nav.coreValues"), href: "#values", desc: t("nav.coreValuesDesc") },
        ],
      },
      {
