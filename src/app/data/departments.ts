...
export const MEMBER_CHURCHES: MemberChurch[] = [
  ...
  { name: "Association des Eglises Pentecôte au Rwanda (ADEPR)", url: "http://www.adeprchurch.rw/" },
  { name: "Eglise Evangelique des Amis au Rwanda (EEAR)", url: "https://www.evangelicalfriendschurchofrwanda.com/" },
  { name: "Harvest Christian Church (HCC)" },
  { name: "Eglise Luthérienne du Rwanda (LCR)", url: "https://lutheranchurchofrwanda.org/" },
  { name: "The Salvation Army (SA)", url: "https://www.salvationarmy.org/territories/rwanda" },
  { name: "Believers Eastern Church (BEC)", url: "https://www.bec.org/" },
  { name: "SIERRA Community Church (SIERRA CC)", url: "https://www.seirachurch.org" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Kigali (EAR/D Kigali)" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Shyira (EAR/D Shyira)" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Butare (EAR/D Butare)", url: "https://www.earbutarediocese.org/" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Gahini (EAR/D Gahini)" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Gasabo (EAR/D Gasabo)", url: "https://eargasabo.rw/" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Byumba (EAR/D Byumba)" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Kigeme (EAR/D Kigeme)", url: "https://kigemediocese.rw/" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Shyigwe (EAR/D Shyogwe)", url: "https://earshyogwe.com/" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Kibungo (EAR/D Kibungo)" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Cyangugu (EAR/D Cyangugu)", url: "https://www.earcyangugudiocese.rw/" },
  { name: "Eglise Anglicane au Rwanda, Diocese de Karongi (EAR/D Karongi)" },
  { name: "Eglise Adventiste du Septieme Jour (EASJ)", url: "https://www.rumadventist.org/" },
  { name: "African Evangelisticis Enterprise (AEE)", url: "https://www.aeerwanda.ngo/" },
  { name: "African Leadership and Reconciliation Ministries (ALARM)", url: "https://www.alarm-inc.org/" },
  { name: "BARAKABAHO Foundation" },
  { name: "Rwanda Youth for Christ", url: "https://www.christchurch.us/" },
