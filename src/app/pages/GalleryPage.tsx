...
const GALLERY_EVENTS: GalleryEvent[] = [
  {
    ...
    images: [
      { src: "/cpr/assets/autorites.webp", alt: "CPR leadership together with national partners" },
      { src: "/cpr/assets/secretariat-meetings.webp", alt: "Plenary session on strategic Church initiatives" },
      { src: "/cpr/assets/cpr-members.webp", alt: "Delegates from Protestant member denominations" },
      { src: "/cpr/assets/handover.webp", alt: "Leadership transition and prayer of blessing" },
      { src: "/cpr/assets/secretariat-sg.webp", alt: "Office of the Secretary General delegation" },
      { src: "/cpr/assets/secretariat-events.webp", alt: "National planning symposium participants" },
      { src: "/cpr/assets/Bisanzeda.webp", alt: "Community outreach program inauguration" },
      { src: "/cpr/assets/secretariat-publications.webp", alt: "Presentation of CPR annual impact reports" },
    ],
  },
  {
    ...
    images: [
      { src: "/cpr/assets/Kwibuka 1 - Copy.png", alt: "Interfaith leaders united in solemn remembrance" },
      { src: "/cpr/assets/Kwibuka 3.png", alt: "Wreath laying ceremony at genocide memorial" },
      { src: "/cpr/assets/Kwibuka 4 - Copy.png", alt: "Congregants praying during commemoration service" },
      { src: "/cpr/assets/Kwibuka 7.jpg", alt: "Youth lighting candles of hope and resilience" },
      { src: "/cpr/assets/news-kwibuka.jpg", alt: "CPR Secretary General delivering words of comfort" },
      { src: "/cpr/assets/3.jpeg", alt: "Church members participating in healing dialogue" },
      { src: "/cpr/assets/1.jpeg", alt: "Community reflection and mutual support group" },
      { src: "/cpr/assets/2.jpeg", alt: "Pastoral counseling sessions after remembrance" },
    ],
  },
  {
    category: "youth",
    ...
    images: [
      { src: "/cpr/assets/Trauma 1.webp", alt: "Community mental health seminar and workshops" },
      { src: "/cpr/assets/news-trauma.jpg", alt: "Group counseling and socio-economic support" },
      { src: "/cpr/assets/Mental 1.webp", alt: "Youth training session on psychosocial healing" },
      { src: "/cpr/assets/Mental 2.webp", alt: "Interactive peacebuilding dialogue among youth" },
      { src: "/cpr/assets/Mental 8.webp", alt: "Graduation of peer counselors in local parishes" },
      { src: "/cpr/assets/Youth2.webp", alt: "Youth festival celebrating harmony and faith" },
      { src: "/cpr/assets/youth.webp", alt: "Young volunteers joining environmental works" },
      { src: "/cpr/assets/school-visit.webp", alt: "Pastoral visit and mentoring at member schools" },
    ],
  },
  {
    category: "education",
    ...
    images: [
      { src: "/cpr/assets/radio-hero.webp", alt: "Radio Inkoramutima broadcast transmitter and studios" },
      { src: "/cpr/assets/radio-studio.webp", alt: "Live studio broadcast for daily devotionals" },
      { src: "/cpr/assets/education.webp", alt: "Protestant schools leadership workshop" },
      { src: "/cpr/assets/news-education.webp", alt: "Curriculum development and values education" },
      { src: "/cpr/assets/news-pedagogy.jpg", alt: "Pedagogical excellence seminar for teachers" },
      { src: "/cpr/assets/Primary.jpg", alt: "Primary school scholarship program beneficiaries" },
      { src: "/cpr/assets/Gahini 2.webp", alt: "Historical Gahini parish church architecture" },
      { src: "/cpr/assets/Gahini 3.webp", alt: "Gahini school expansion and community health program" },
    ],
  },
];
...
export function GalleryPage() {
  ...
  return (
    <main style={{ backgroundColor: "rgba(255, 255, 255, 0.88)" }}>
      ...
      <div
        ref={heroRef}
        className="relative min-h-[55vh] sm:min-h-[65vh] md:min-h-[75vh] lg:min-h-[calc(100vh-130px)] flex items-end justify-start pb-16 px-6 lg:px-12 text-white overflow-hidden"
      >
        <motion.div
          className="absolute inset-0"
          style={{
            backgroundImage:
              "linear-gradient(rgba(78,97,50,0.45), rgba(78,97,50,0.88)), url('/cpr/assets/Bisanzeda.webp')",
