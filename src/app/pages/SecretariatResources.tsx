      ...
      <main className="bg-white min-h-screen flex items-center justify-center">
        <div className="text-center px-6">
          <h1 className="font-['Outfit'] font-black text-4xl text-[#4E6132] mb-4">
            {t("departmentResourcesUI.deptNotFoundTitle", { defaultValue: "Section Not Found" })}
          </h1>
          <p className="text-[#4A4A4A] mb-8">
            {t("departmentResourcesUI.deptNotFoundDesc", { defaultValue: "We couldn't find the secretariat section you're looking for." })}
          </p>
          <Link
            to="/secretariat"
          ...
          >
            <ArrowLeft size={16} /> {t("departmentResourcesUI.backToDepartments", { defaultValue: "Back to Secretariat" })}
          </Link>
        </div>
      </main>
    );
    ...
    <main className="bg-white">
      ...
      >
        <div className="relative z-10 max-w-7xl w-full mx-auto">
          ...
          >
            <ArrowLeft size={14} /> {t("departmentResourcesUI.backToDepartments", { defaultValue: "Back to Secretariat" })}
          </Link>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {section.resources.map((resource, idx) => {
                return (
                  ...
                  >
                    <Link
                      to={`/secretariat/${section.id}/resources/${resource.slug}`}
      ...
      <section className="py-16 bg-[#4E6132] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center relative z-10">
          <h2 className="font-['Outfit'] font-black text-2xl lg:text-3xl text-white mb-4">
            {t("departmentResourcesUI.exploreMore", { defaultValue: "Explore More" })}
          </h2>
          <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
            {t("departmentResourcesUI.discoverHow", { defaultValue: "Discover more about CPR's work and mission." })}
          </p>
          <Link
            to="/secretariat"
          ...
          >
            <ArrowLeft size={16} /> {t("departmentResourcesUI.allDepartments", { defaultValue: "Back to Secretariat" })}
          </Link>
        </div>
      </section>
    </main>
