...
import {
  Shield, FileText, Lock, Share2, Server,
  Globe, UserCheck, RefreshCw, Mail, ArrowLeft, Heart,
  type LucideIcon,
} from "lucide-react";
...
export function TermsOfService() {
  ...
  const raw = t("termsOfService.sections", { returnObjects: true }) as unknown;
  const sections = (Array.isArray(raw) ? raw : []) as TermsSection[];

  const heroDesc = t("termsOfService.heroDesc");
  const lastUpdated = t("termsOfService.lastUpdated");
  const contactIntro = t("termsOfService.contactIntro");
    ...
    <main className="bg-white">
      ...
      >
        ...
        >
          ...
          >
            <FileText size={15} className="text-[#EAD196]" />
